...
<body>
    <header> 
            <div class="haut">      
                <a href="crudvendeur.php"><img class="logo" src="images/logo/logofiniresizes.png" alt="logo alizon" title="logo alizon" ></a>
        ...
        try{
            ...
            echo '<div class="formulaire"> 
                    ...
                    if(!empty($_POST["nom"])&&!empty($_POST["descript"])&&!empty($_POST["prixcoutant"])&&!empty($_POST["prixht"])&&!empty($_POST["quantitestock"])&&!empty($_POST["seuilalerte"])){
                        $sth->execute(array($_POST["nom"],$_POST["prixht"],$_POST["prixcoutant"],$_POST["descript"],$_POST["quantitestock"],$_POST["seuilalerte"],$_POST["idsouscategorie"],$_SESSION["idvendeur"]));
                        
                            $last_id = $dbh->lastInsertId();
                            
                        $imgbdd->execute(array($last_id,"images/imgArticle/".$_FILES["file"]["name"]));
                          
                        echo' <form id="formulaire" enctype="multipart/form-data" method="post" action="createArticle.php"  >';
